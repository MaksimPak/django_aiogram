# Generated by Django 3.2 on 2021-04-29 10:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stream', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dashboard.stream')),
                ('student', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='dashboard.student')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='student',
            name='lessons',
            field=models.ManyToManyField(to='dashboard.Lesson'),
        ),
        migrations.CreateModel(
            name='User',
            fields=[
